...
output, deltas = model.build_auto(codes, deltas)
t_metrics, t_summary = model.get_auto_metrics(output, deltas, categories, \
    weights)
...
with tf.variable_scope('optimizer'):
  ...
  grads, t_grad_norm = tf.clip_by_global_norm(grads, 20.0)
